...
const Header = () => {
const [isPage , setPage] = useState('Гидроциклы')
    ...
    <div className={classes.header}>
        ...
        <div className={classes.underBlock}>
            <Link to="/" onClick={()=>handleChangePage('Катера')} className={isPage === 'Катера' && classes.active}>Катера</Link>
            <Link to="/hydrocicls" onClick={()=>handleChangePage('Гидроциклы')} className={isPage === 'Гидроциклы' && classes.active}>Гидроциклы</Link>
            <Link  onClick={()=>handleChangePage('Лодки')} className={isPage === 'Лодки' && classes.active}>Лодки</Link>
            <Link  onClick={()=>handleChangePage('Вездеходы')} className={isPage === 'Вездеходы' && classes.active}>Вездеходы</Link>
            <Link  href="#">Снегоходы</Link>
            <Link  href="#">Двигатели</Link>
